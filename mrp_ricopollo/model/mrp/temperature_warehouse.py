...
class temperature_warehouse(osv.osv):
    _name = 'temperature.warehouse'
    ...
    _columns ={        
        ...
        'in_morning': fields.integer('Mañana'),
        'in_afternoon': fields.integer('Tarde'),
        'in_night': fields.integer('Noche'),
        'out_morning': fields.integer('Mañana'),
        'out_afternoon': fields.integer('Tarde'),
        'out_night': fields.integer('Noche'),
        #'temperature_line_ids': fields.one2many('temperature.warehouse.detail', 'temperature_id', 'Temperature', readonly=True, states={'draft': [('readonly', False)]}),
